...
//                     </Button>
//                     <Button size="sm" className="bg-primary hover:bg-primary/90 h-8" onClick={() => window.location.href = `/video-call/${consultation.id}`}>{t.dashboard.joinCall}
//                     </Button>
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-primary mb-2">
              {t.dashboard.welcome}, Ramesh Kumar
            </h1>
            <p className="text-muted-foreground">Patient ID: HC001234 | Last Login: Today, 09:30 AM</p>
          </div>
          <div className="flex items-center space-x-3">
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            ...
                            onClick={() => (window.location.href = "/consultation/1")}
                          >
                            {t.dashboard.joinCall}
                          </Button>
                        </div>
